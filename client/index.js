    ...
    fetch('/api/tasks')
        ...
        .then((response) => {
            response.forEach((task) => {
                ...
                actions.innerHTML = `<button class="button is-small is-danger" id="deleteTask${task.id}" onclick="completeTask('${task.id}');"><span class="icon is-small"><i class="fas fa-trash-alt"></i></span></button>`
